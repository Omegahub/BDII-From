...
/* select */
select cd_cargo as 'Codigo Cargo',
	   ds_cargo as 'Especialização'
from cargo;


select cd_depto as 'Codigo Departamento',
	   sg_depto as  'Sigla Departamento'
from departamento
where cd_depto = 20 or cd_depto = 40


select cd_func			as 'Codigo do Funcionario',
	   cd_depto			as 'Codigo Departamento',
	   nm_pnome_func	as 'Nome do Funcionario',
	   nm_unome_func	as 'Ultimo nome',
	   vl_salario		as 'Valor do Salario'
from funcionario
...
from funcionario
where dt_inicio between '2015-06-03' and '2015-08-01'